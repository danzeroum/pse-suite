...
FAMILIAS = (
    ...
    ("mordida", "Provas negativas — o gate tem de morder",
     ...
     ["test_mordida.py", "test_mutacao.py", "test_ratificacao.py",
      "test_reprodutibilidade.py", "test_indice.py", "test_orfao.py"]),
    ("conserto", "O conserto medido contra alvos reais",
     "Os tres refinos que a rodada de reconhecimento contra 6 repositorios "
     "de fintech e legaltech expos — defeitos da PROPRIA suite que nenhuma "
     "fixture pegaria, e que nenhum deles teria aparecido sem alvo de verdade.",
     ["test_conserto_severidade.py", "test_conserto_alcance.py",
      "test_conserto_dominio.py"]),
