...
| **P-06** | backend | estatico / inventory | CRITICO | — | a chave de pseudonimizacao morando junto do dado que ela protege. |
...
## B.4 Contrato e autorizacao — 64 funcoes
...
| `test_trabalho_b.py` | 12 | 12 | `mordida`, `pse_ethics`, `pse_privacy`, `pse_security` | Trabalho B contra fixture com violacoes + contrato de veredito. |
...
## B.8 Integracao de ponta a ponta — 37 funcoes
...
|---|---|---|
| `mordida` | testes negativos que provam que o gate aborta | `test_aceite.py`, `test_api_estrato.py`, `test_backend_estrato.py`, `test_contrato.py`, `test_data_estrato.py`, `test_dinamico.py`, `test_dinamico_fase2.py`, `test_dominio.py`, `test_fase3.py`, `test_frontend.py`, `test_ia_estrato.py`, `test_ia_terceiros.py`, `test_indice.py`, `test_lineage.py`, `test_mordida.py`, `test_mutacao.py`, `test_navegador.py`, `test_reprodutibilidade.py`, `test_trabalho_a.py`, `test_trabalho_b.py` |
...
| `pse_privacy` | checks do pacote P (Privacidade) | `test_api_estrato.py`, `test_backend_estrato.py`, `test_data_estrato.py`, `test_dinamico.py`, `test_dinamico_fase2.py`, `test_fase3.py`, `test_ia_estrato.py`, `test_trabalho_a.py`, `test_trabalho_b.py` |
| `pse_security` | checks do pacote S (Seguranca) | `test_api_estrato.py`, `test_backend_estrato.py`, `test_dinamico.py`, `test_dinamico_fase2.py`, `test_fase3.py`, `test_ia_estrato.py`, `test_trabalho_a.py`, `test_trabalho_b.py` |
